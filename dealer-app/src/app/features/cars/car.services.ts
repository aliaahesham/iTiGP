...
export class carService {
    ...
    constructor() {
        this.data = [
            ...
            { id: 8, code: "S567", seller: "Caroline ", making: { name: 'Kia' }, classification: 'Level B', color: 'DarkRed', model: { name: 'Sportage', id: 8 }, fuelTank: 45, price:180000,
            ...
            { id: 9, code: "B729", seller: "Veronia", making: { name: 'Kia' }, classification: 'Level A', color: 'Silver', model: { name: 'Optima', id: 9 }, fuelTank: 50, price:230000,
