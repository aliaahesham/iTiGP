...
export class AccessoriesService {
    ...
    constructor() {
        this.data = [
            ...
            { id: 5, code: "R87P", seller: "RK Anjel", name: "Armor Vacuum Cleaner", description: " can do wonders for the cleanliness of your vehicle", price: 110, image: "['assets/img/products/product-grey-1.jpg']" },
            { id: 6, code: "FT22", seller: "Xperience", name: "HUD", description: "turns any smartphone into a heads-up display (HUD) for your vehicle", price: 80, image: "['assets/img/products/product-grey-1.jpg']" },
            { id: 7, code: "PL56", seller: "Xperience", name: "Puncture repair kit", description: "They're designed to be easy to use and are quicker than replacing a wheel", price: 2000, image: "['assets/img/products/product-grey-1.jpg']" },
            { id: 8, code: "FH56", seller: "Xperience", name: "Car cover", description: "A cover keeps a car dirt and dust free when parked besides bird droppings, rain sunlight and the elements", price: 150, image: "['assets/img/products/product-grey-1.jpg']" }
        ]
    }
    getAll(): Accessories[] {
        return this.data;
